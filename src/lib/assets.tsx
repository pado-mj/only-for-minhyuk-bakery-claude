...
export const DECORATION_ASSETS: DecorationAsset[] = [
  ...
  { id: "dog-maltese", category: "dog", labelKo: "말티즈", labelEn: "Maltese", labelJa: "マルチーズ", Icon: Maltese },
  { id: "dog-chihuahua", category: "dog", labelKo: "치와와", labelEn: "Chihuahua", labelJa: "チワワ", Icon: Chihuahua },
  { id: "dog-german-shepherd", category: "dog", labelKo: "저먼 셰퍼드", labelEn: "German Shepherd", labelJa: "ジャーマンシェパード", Icon: GermanShepherd },
